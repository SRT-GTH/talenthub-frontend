...
/*
 * OnboardingDobPage — Step 1 of the talent onboarding flow.
 ...
 * profile…" overlay before navigating onward — the next route is
...
const DataProtectedCard = () => (
  // Trust banner sitting in the upper-left of the right panel — Figma
...
const CompliancePill = () => (
  // Top-right pill — Figma node 2282:9043. White rounded pill with
...
const ExperiencePickerCard = () => (
  // "Adult experience / Youth experience" floating selector — Figma
  // node 2282:9050. The Adult row is the active option (green/600);
  // Youth is muted grey. Each row carries a 6×6 dot indicator.
  <div
...
const WatchTutorialCard = () => (
  // "Watch tutorial" instance — Figma 2282:9059. Small card with a
...
const BasicsRightPanel = () => (
  // Right showcase panel — Figma Frame 141 (2282:9014). 42% of the
  ...
  // top. The full 3-photo composition is deferred — once a final
...
const LoadingOverlay = () => (
  ...
  // 2282:23881 — sits below the safari chrome (top 52px) with a
  ...
  >
    ...
    >
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="flex flex-col items-center gap-1 text-center">
          ...
          >
            Building your <span className="italic text-brand-green">student profile…</span>
          </p>
    ...
    {/* Keyframes for the indeterminate rail — keeps the overlay
...
const OnboardingDobPage = () => {
  ...
  // Derived state — single source of truth for "is this entry valid".
      ...
      <section className="flex flex-1">
        ...
        <div className="flex flex-1 items-start justify-center px-6 pt-12 pb-12 md:pt-16">
          <form
            ...
            noValidate
          >
            {/* Eyebrow — "01" italic ordinal + "The Basics" label */}
            ...
            {/* Under-18 notice — Figma node 2282:23881 (notes symbol).
