...
/** Old split route → shared shell + force recruiter demo role. */
function LegacyRecruiterBuddyRedirect() {
  const { setRole } = useCareerBuddyRole();
  useEffect(() => {
    setRole('recruiter');
  }, [setRole]);
  return <Navigate to="/profile/filling/career-buddy?cb=welcome" replace />;
}
